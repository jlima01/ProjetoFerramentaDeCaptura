...
public class FerramentaDeCapturaEditor : ScriptableWizard
{
    ...
    private void DrawVariables()
    {
        ...
        camera = EditorGUILayout.ObjectField("Objeto De Captura", camera, typeof(GameObject), true) as GameObject;
	...
	private void SetParameters()
	{
        ...
        spawn.GameObject.tag = "Spawn";
        spawn.GameObject.name = "PosicaoDeCapturaPadrao";
		camera = new GameObject();
        camera.GameObject.name = "ObjetoDeCaptura";
